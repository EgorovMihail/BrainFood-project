      ...
      <nav class="menu">
        ...
        <ul class="menu__list">
          <li class="menu__list-item">
            <a data-goto=".main" class="menu__list-link active" href="#">
              на главную
            </a>
          </li>
          <li class="menu__list-item">
            <a data-goto=".section__advantages" class="menu__list-link" href="#">
              преимущества
            </a>
          </li>
          <li class="menu__list-item">
            <a data-goto=".section__education" class="menu__list-link" href="#">обучение</a>
          </li>
          <li class="menu__list-item">
            <a data-goto=".section__courses" class="menu__list-link" href="#">каталог курсов</a>
          </li>
        </ul>
